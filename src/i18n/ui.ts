...
export const ui = {
  it: {
    ...
    'eventi.meta.title':     'Eventi e musica dal vivo · Biblio Treviso',
    ...
    'contatti.meta.title':   'Contatti e come arrivare · Biblio Treviso',
    ...
    'news.meta.title':       'News e novità · Biblio Treviso',
    ...
    'truck.menus.title':    'Food e drink',
    ...
    'home.cucina.eyebrow':  'Cucina e bancone',
    ...
    'menu.tab.drink':       'Drink e Vini',
    'menu.tab.food':        'Cicchetti e Cucina',
    ...
    'eventi.title':         'Eventi e musica dal vivo',
    ...
    'eventi.readmore':      'Scopri la serata',
    'eventi.back':          '← Tutti gli eventi',
    ...
    'contatti.title':       'Contatti e Come arrivare',
    ...
    'artisti.form.genre.other.label': 'Specifica il genere',
    'artisti.form.genre.other.placeholder': 'Es. funk, reggae, elettronica…',
    ...
    'artisti.form.files':             'Carica i tuoi file',
    'artisti.form.files.hint':        'Audio, foto o PDF — fino a 5 file, max 20MB l\'uno (jpg, png, webp, pdf, mp3, m4a, wav).',
    'artisti.form.files.uploading':   'Caricamento dei file in corso…',
    ...
    'artisti.success.popup':          'Grazie per la candidatura, a presto',
  ...
  en: {
    ...
    'eventi.meta.title':     'Events and live music · Biblio Treviso',
    ...
    'contatti.meta.title':   'Contact and how to find us · Biblio Treviso',
    ...
    'news.meta.title':       'News and updates · Biblio Treviso',
    ...
    'truck.menus.title':    'Food and drink',
    ...
    'home.cucina.eyebrow':  'Kitchen and bar',
    ...
    'evento.ven.title':     'Blues and Soul',
    ...
    'menu.tab.drink':       'Drinks and Wine',
    'menu.tab.food':        'Small plates and Kitchen',
    ...
    'eventi.title':         'Events and Live Music',
    ...
    'eventi.readmore':      'See the night',
    'eventi.back':          '← All events',
    ...
    'contatti.title':       'Contact and How to find us',
    ...
    'artisti.form.genre.other.label': 'Specify the genre',
    'artisti.form.genre.other.placeholder': 'E.g. funk, reggae, electronic…',
    ...
    'artisti.form.files':             'Upload your files',
    'artisti.form.files.hint':        'Audio, photos or PDF — up to 5 files, max 20MB each (jpg, png, webp, pdf, mp3, m4a, wav).',
    'artisti.form.files.uploading':   'Uploading your files…',
    ...
    'artisti.success.popup':          'Thanks for your application, see you soon',
