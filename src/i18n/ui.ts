...
export const ui = {
  it: {
    ...
    'eventi.weekly.intro':  'Tre serate fisse a settimana, generi che cambiano artista ogni volta. La cucina apre dalle 18:00 e accompagna il concerto fino a tardi.',
    ...
    'footer.about':         'Un locale di musica dal vivo nel cuore di Treviso. Drink d\'autore, cicchetti gourmet e tre sere a settimana di concerti — tra lampade d\'epoca e legno scuro.',
  ...
  en: {
    ...
    'eventi.lede':          'Live music at least three nights a week, different artists each time. We post the posters here as soon as they\'re confirmed — also on Instagram.',
    ...
    'eventi.weekly.intro':  'Three fixed nights a week, the genre stays and the artist changes every time. The kitchen opens at 6 PM and stays alongside the music until late.',
    ...
    'footer.tagline':       'art · food · drink · Treviso',
    'footer.about':         'A live-music bar in the heart of Treviso. Signature drinks, gourmet small plates, and three nights a week of concerts — under vintage lamps and dark wood.',
